...
def gen_feature_matrix(entityset, features_only=False, feature_matrix_encode=False,
    ...
    agg_primitives = ['last', 'mean', 'max', 'min', 'std']#, 'skew', 'time_since_last', 'trend'] # trend takes extremely long time to compute
    ...
    if goldstandard_exist:
        ...
        feature_matrix = feature_matrix.join(goldstandard, how='right')
